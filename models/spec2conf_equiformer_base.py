...
@register_model
def spec2conf_equiformer_base_moe2(**kwargs):
    model = Spec2ConfEquiformerBase(encoder_layers=2, pooling_layers=4, num_experts=2, **kwargs)
    return model

@register_model
def spec2conf_equiformer_base_moe3(**kwargs):
    model = Spec2ConfEquiformerBase(encoder_layers=2, pooling_layers=4, num_experts=3, **kwargs)
    return model

@register_model
def spec2conf_equiformer_base_moe4(**kwargs):
    model = Spec2ConfEquiformerBase(encoder_layers=2, pooling_layers=4, num_experts=4, **kwargs)
    return model

@register_model
def spec2conf_equiformer_base_moe5(**kwargs):
    model = Spec2ConfEquiformerBase(encoder_layers=2, pooling_layers=4, num_experts=5, **kwargs)
    return model

@register_model
def spec2conf_equiformer_base_moe6(**kwargs):
    model = Spec2ConfEquiformerBase(encoder_layers=2, pooling_layers=4, num_experts=6, **kwargs)
    return model