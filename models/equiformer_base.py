...
def equiformer_base(irreps_in='36x0e', radius=5.0, num_basis=128, irreps_feature='256x0e',
    atomref=None, task_mean=None, task_std=None, scattering=True, task=None, **kwargs):
